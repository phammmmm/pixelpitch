...
$controller = new CustomerController();
    ...
    if(empty($email_err) && empty($name_err)){
        ...
        $controller->updateCustomerDetails($firstName,$lastName,$contact,$email,$address,$_SESSION['customer_id']);
    }
  }else{
    $customer = $controller->getCustomerById($_SESSION['customer_id']);
